...
var validation_rules = checkSchema({
    company_name: {
        errorMessage:
            "Company Name should be at least 3 chars long and maximum of 50 chars",
        isLength: {
    ...
    profile_name: {
        errorMessage:
            "Public Profile Name should be at least 3 chars long and maximum of 50 chars",
        isLength: {
            options: { min: 3, max: 50 },
        },
        trim: true,
    ...
    description: {
        errorMessage:
            "Company Description should be at least 2 chars long and maximum of 200 chars",
        isLength: {
    ...
    company_street_address: {
        errorMessage:
            "Company Address should be at least 3 chars long and maximum of 100 chars",
        isLength: {
    ...
    company_city: {
        errorMessage:
            "City should be at least 5 chars long and maximum of 50 chars",
        isLength: {
    ...
    company_zip: {
        errorMessage:
            "Zip Code should be at least 4 chars long and maximum of 6 chars",
        isLength: {
            options: { min: 4, max: 6 },
        },
        trim: true,
    ...
    first_name: {
        errorMessage:
            "First Name should be at least 3 chars long and maximum of 50 chars",
        isLength: {
            options: { min: 3, max: 50 },
        },
        trim: true,
    ...
    last_name: {
        errorMessage:
            "Last Name should be at least 3 chars long and maximum of 50 chars",
        isLength: {
            options: { min: 3, max: 50 },
        },
        trim: true,
    ...
    "card.type": {
        ...
        custom: {
            options: (value, { req }) =>
                req.body.payment_mode === "Credit Card" && value == ""
                    ? false
                    : true,
        },
    },
    ...
    "card.cvv": {
        ...
        custom: {
            ...
            errorMessage:
                "Security code number must be of 3 and maximum of 4 digits",
        },
    },
});
